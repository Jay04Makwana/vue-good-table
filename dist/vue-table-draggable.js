...
(function (global, factory) {
  ...
  (factory((global.vueTableDraggable = {})));
  ...
  var script$6 = {
    ...
    methods: {
      ...
      isSortableColumn: function isSortableColumn(index$$1) {
        var sortable$$1 = this.columns[index$$1].sortable;
        var isSortable = typeof sortable$$1 === 'boolean' ? sortable$$1 : this.sortable;
        return isSortable;
      },
      ...
      //   }
      // },
      arrayMove: function arrayMove(items, oldIndex, newIndex) {
    ...
    mounted: function mounted() {
      ...
      this.$nextTick(function () {
        var sortable$$1 = new Sortable(_this6.$refs.tbody, {
          draggable: 'tr',
          mirror: {
        ...
        sortable$$1.on('sortable:stop', function (e) {
          _this6.$emit('on-dragged', e);

          _this6.arrayMove(_this6.rows, e.oldIndex, e.newIndex);
        });
      });
    },
    components: {
  ...
  var __vue_staticRenderFns__$6 = [];
    ...
    var VueTableDraggable = normalizeComponent_1(
  ...
  exports.default = VueTableDraggablePlugin;
  exports.VueTableDraggable = VueTableDraggable;
